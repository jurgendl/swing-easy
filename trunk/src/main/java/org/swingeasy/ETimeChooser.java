 ...
 * @author Jurgen
 */
public class ETimeChooser extends EDateChooser {
    ...
    public ETimeChooser(Date date) {
        super(date);
    }

    public ETimeChooser(Date date, Locale locale) {
        super(date, locale);
    }

    public ETimeChooser(Date date, Locale locale, TimeZone tz) {
        super(date, locale, tz);
    }

    /**
     * @see org.swingeasy.EDateChooser#getDayPanel()
     */
    @Override
