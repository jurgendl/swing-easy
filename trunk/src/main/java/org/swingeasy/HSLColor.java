...
/**
 * The HSLColor class provides methods to manipulate HSL (Hue, Saturation Luminance) values to create a corresponding Color object using the RGB
 * ColorSpace.
 * 
 * The HUE is the color, the Saturation is the purity of the color (with respect to grey) and Luminance is the brightness of the color (with respect
 * to black and white)
 * 
 * The Hue is specified as an angel between 0 - 360 degrees where red is 0, green is 120 and blue is 240. In between you have the colors of the
 * rainbow. Saturation is specified as a percentage between 0 - 100 where 100 is fully saturated and 0 approaches gray. Luminance is specified as a
 ...
 * 
 * @see http://tips4java.wordpress.com/2009/07/05/hsl-color/#more-1116
 */
public class HSLColor {
    ...
    /**
     * Convert HSL values to a RGB Color with a default alpha value of 1. H (Hue) is specified as degrees in the range 0 - 360. S (Saturation) is
     * specified as a percentage in the range 1 - 100. L (Lumanance) is specified as a percentage in the range 1 - 100.
     * 
    ...
    /**
     * Convert HSL values to a RGB Color. H (Hue) is specified as degrees in the range 0 - 360. S (Saturation) is specified as a percentage in the
     * range 1 - 100. L (Lumanance) is specified as a percentage in the range 1 - 100.
     * 
     * @param hsl an array containing the 3 HSL values
     * @param alpha the alpha value between 0 - 1
     * 
    ...
    /**
     * Create a RGB Color object based on this HSLColor with a different Shade. Changing the shade will return a darker color. The percent specified
     * is a relative value.
     * 
    ...
    /**
     * Create a RGB Color object based on this HSLColor with a different Tone. Changing the tone will return a lighter color. The percent specified is
     * a relative value.
     * 
     * @param percent - the value between 0 - 100
     * @return the RGB Color object
    ...
    /**
     * Create a RGB Color object that is the complementary color of this HSLColor. This is a convenience method. The complementary color is determined
     * by adding 180 degrees to the Hue value.
     * 
     * @return the RGB Color object
     */
