...
public final class MethodInvoker {
    ...
    public boolean equals(final Object other) {
        ...
        return new EqualsBuilder().append(this.invoker, castOther.invoker).append(this.methodName, castOther.methodName)
                .append(this.types, castOther.types).isEquals();
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).appendSuper(super.toString()).append("invoker", this.invoker)
                .append("methodName", this.methodName).append("types", this.types).append("method", this.method)
                .append("parameters", this.parameters).append("returns", this.returns).toString();
    }
}
