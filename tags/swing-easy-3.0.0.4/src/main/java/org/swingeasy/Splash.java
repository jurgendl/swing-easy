...
public class Splash extends JComponent {
    ...
    public void paint(Graphics g) {
        ...
        g2.fillOval(this.progressBarLocation.x - (this.progressBarLocation.height / 2), this.progressBarLocation.y, this.progressBarLocation.height,
                this.progressBarLocation.height);
        g2.fillOval((this.progressBarLocation.x + this.progressBarLocation.width) - (this.progressBarLocation.height / 2),
                this.progressBarLocation.y, this.progressBarLocation.height, this.progressBarLocation.height);
